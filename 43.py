...
class Browser(QWidget):
	...
	def __init__(self):
		...
		self.webview.load("https://www.baidu.com/")
		...
		self.favourites.addItems([r"http://www.google.com",
								r"http://www.raspberrypi.org",
								r"http://docs.python.org/3/"])
	...
	def search_btn_clicked(self):
		self.webview.load("https://www.baidu.com/s?ie=UTF-8&wd=" + self.search_box.text())
